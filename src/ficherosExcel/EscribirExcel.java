...
public static void main(String[] args) {
		...
		String nombreArchivo="Invefsdfsd.xlsx";
		String rutaArchivo= "/Users/joyner/Desktop/workspace/"+nombreArchivo;
		String hoja="Hoja1";
		
		XSSFWorkbook libro= new XSSFWorkbook();
		XSSFSheet hoja1 = libro.createSheet(hoja);
		//cabecera de la hoja de excel
		String [] header= new String[]{"C�digo", "Producto","Precio","Unidades"};
